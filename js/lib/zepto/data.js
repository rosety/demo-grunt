define(function(require, exports, module) {
    ...
    function($) {
        ...
        function setData(node, name, value) {
            ...
            return void 0 !== name && (store[camelize(name)] = value),
            store
        }
        function attributeData(node) {
            var store = {};
            return $.each(node.attributes || emptyArray, 
            function(i, attr) {
        ...
        $.fn.removeData = function(names) {
            return "string" == typeof names && (names = names.split(/\s+/)),
            this.each(function() {
                var id = this[exp],
                store = id && data[id];
                store && $.each(names || store, 
                function(key) {
        ...
        ["remove", "empty"].forEach(function(methodName) {
            ...
            $.fn[methodName] = function() {
                ...
                return "remove" === methodName && (elements = elements.add(this)),
                elements.removeData(),
                origFn.call(this)
            }
        })
