define(function(require, exports, module) {
    ...
    function($) {
        ...
        function longTap() {
            longTapTimeout = null,
            touch.last && (touch.el.trigger("longTap"), touch = {})
        }
        ...
        $(document).ready(function() {
            ...
            function(e) { (!(_isPointerType = isPointerEventType(e, "up")) || isPrimaryTouch(e)) && (cancelLongTap(), touch.x2 && Math.abs(touch.x1 - touch.x2) > 30 || touch.y2 && Math.abs(touch.y1 - touch.y2) > 30 ? swipeTimeout = setTimeout(function() {
                ...
                0) : "last" in touch && (30 > deltaX && 30 > deltaY ? tapTimeout = setTimeout(function() {
                    ...
                    touch.isDoubleTap ? (touch.el && touch.el.trigger("doubleTap"), touch = {}) : touchTimeout = setTimeout(function() {
                        touchTimeout = null,
